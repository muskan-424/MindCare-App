...
This section showcases the final user interface of the \textbf{MindCare} application. The screenshots illustrate the seamless flow between authentication, personal wellness tracking, AI-powered interactions with Tink, and the dedicated clinical dashboard for professionals.
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{MindCare Output Screens (Authentication \& Dashboards)}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        ...
        \caption{Chat with Tink}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{screen8.png}
        \caption{Journaling Interface}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        ...
        \caption{Crisis Resources}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{screen11.png}
        \caption{Therapist View}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
    ...
    \end{subfigure}
    \caption{MindCare Output Screens (AI & Wellness Tools)}
\end{figure}
...
\begin{figure}[H]
    ...
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{screen15.png}
        \caption{Notification Center}
    \end{subfigure}
    \vspace{0.5cm}

    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{screen16.png}
        \caption{Historical Trends}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{screen17.png}
        \caption{Appointment Booking}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{screen18.png}
        \caption{Secure Login (Admin)}
    \end{subfigure}
    \caption{MindCare Output Screens (Account & Administration)}
\end{figure}

\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{screen19.png}
        \caption{System Logs}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{screen20.png}
        \caption{Feedback Form}
    \end{subfigure}
    \caption{MindCare Output Screens (Feedback & Logging)}
\end{figure}
